...
- **Enhanced Error Messages**: Implement user-friendly error messages for authentication failures, especially for OAuth providers (GitHub, Google).
  - *Justification*: Clear error messages reduce support tickets and improve conversion rates during signup/login. User with not enough permission should get appropriate error message
  - *Complexity*: Medium
